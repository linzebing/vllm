...
from vllm.utils import GiB_bytes, cdiv, sha256, sha256_cbor_64bit
...
def get_hash_fn_by_name(caching_hash_algo: str) -> Callable:
    """
    ...
    Returns:
        A hash function.
    """
    return (sha256_cbor_64bit if caching_hash_algo == "sha256_cbor_64bit" else
